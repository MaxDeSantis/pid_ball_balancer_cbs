#ifndef _ROS_autoware_config_msgs_ConfigCarKF_h
#define _ROS_autoware_config_msgs_ConfigCarKF_h
...
namespace autoware_config_msgs
{
  ...
  class ConfigCarKF : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_config_msgs/ConfigCarKF"; };
