#ifndef _ROS_autoware_config_msgs_ConfigRandomFilter_h
#define _ROS_autoware_config_msgs_ConfigRandomFilter_h
...
namespace autoware_config_msgs
{
  ...
  class ConfigRandomFilter : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_config_msgs/ConfigRandomFilter"; };
