#ifndef _ROS_autoware_config_msgs_ConfigPedestrianDPM_h
#define _ROS_autoware_config_msgs_ConfigPedestrianDPM_h
...
namespace autoware_config_msgs
{
  ...
  class ConfigPedestrianDPM : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_config_msgs/ConfigPedestrianDPM"; };
