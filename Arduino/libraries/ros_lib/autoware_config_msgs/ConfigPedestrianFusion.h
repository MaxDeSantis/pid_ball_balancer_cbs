#ifndef _ROS_autoware_config_msgs_ConfigPedestrianFusion_h
#define _ROS_autoware_config_msgs_ConfigPedestrianFusion_h
...
namespace autoware_config_msgs
{
  ...
  class ConfigPedestrianFusion : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_config_msgs/ConfigPedestrianFusion"; };
