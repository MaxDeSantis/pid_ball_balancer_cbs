#ifndef _ROS_autoware_config_msgs_ConfigApproximateNDTMapping_h
#define _ROS_autoware_config_msgs_ConfigApproximateNDTMapping_h
...
namespace autoware_config_msgs
{
  ...
  class ConfigApproximateNDTMapping : public ros::Msg
  {
    public:
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_min_add_scan_shift.base >> (8 * 3)) & 0xFF;
      ...
      u_max_submap_size.real = this->max_submap_size;
      *(outbuffer + offset + 0) = (u_max_submap_size.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_max_submap_size.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_max_submap_size.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_max_submap_size.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->max_submap_size);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_max_submap_size.base = 0;
      u_max_submap_size.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_max_submap_size.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_max_submap_size.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_max_submap_size.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->max_submap_size = u_max_submap_size.real;
      offset += sizeof(this->max_submap_size);
     return offset;
    }

    const char * getType(){ return "autoware_config_msgs/ConfigApproximateNDTMapping"; };
    const char * getMD5(){ return "687f2daa2d34290b27e1b1cbc58023a7"; };
