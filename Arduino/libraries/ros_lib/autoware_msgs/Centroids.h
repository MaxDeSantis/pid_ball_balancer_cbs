#ifndef _ROS_autoware_msgs_Centroids_h
#define _ROS_autoware_msgs_Centroids_h
...
namespace autoware_msgs
{
  ...
  class Centroids : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_msgs/Centroids"; };
