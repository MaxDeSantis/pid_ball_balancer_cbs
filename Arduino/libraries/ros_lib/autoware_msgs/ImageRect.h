#ifndef _ROS_autoware_msgs_ImageRect_h
#define _ROS_autoware_msgs_ImageRect_h
...
namespace autoware_msgs
{
  ...
  class ImageRect : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autoware_msgs/ImageRect"; };
    const char * getMD5(){ return "bb25029b34a07f966ba32a6ce98cb199"; };
