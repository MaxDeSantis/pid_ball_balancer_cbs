#ifndef _ROS_lgsvl_msgs_Signal_h
#define _ROS_lgsvl_msgs_Signal_h
...
namespace lgsvl_msgs
{
  ...
  class Signal : public ros::Msg
  {
    public:
      ...
      _score_type score;
      typedef lgsvl_msgs::BoundingBox3D _bbox_type;
      _bbox_type bbox;
    ...
    const char * getType(){ return "lgsvl_msgs/Signal"; };
    const char * getMD5(){ return "9b83e617cea5df32ca4e065ca0b19d18"; };
