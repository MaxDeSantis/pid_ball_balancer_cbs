#ifndef _ROS_lgsvl_msgs_BoundingBox2D_h
#define _ROS_lgsvl_msgs_BoundingBox2D_h
...
namespace lgsvl_msgs
{
  ...
  class BoundingBox2D : public ros::Msg
  {
    ...
    const char * getType(){ return "lgsvl_msgs/BoundingBox2D"; };
    const char * getMD5(){ return "a91ecea8870c8dcc4ddb26473f3471a8"; };
