#ifndef _ROS_tablet_socket_msgs_mode_cmd_h
#define _ROS_tablet_socket_msgs_mode_cmd_h
...
namespace tablet_socket_msgs
{
  ...
  class mode_cmd : public ros::Msg
  {
    ...
    const char * getType(){ return "tablet_socket_msgs/mode_cmd"; };
