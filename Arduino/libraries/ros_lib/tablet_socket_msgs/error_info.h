#ifndef _ROS_tablet_socket_msgs_error_info_h
#define _ROS_tablet_socket_msgs_error_info_h
...
namespace tablet_socket_msgs
{
  ...
  class error_info : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "tablet_socket_msgs/error_info"; };
    const char * getMD5(){ return "1e0599225f135899fc042ad32b56a8e7"; };
