#ifndef _ROS_SERVICE_GetWall_h
#define _ROS_SERVICE_GetWall_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETWALL[] = "vector_map_server/GetWall";

  class GetWallRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETWALL; };
    const char * getMD5(){ return "d1f64bdec952e41012fc8c13f57fef77"; };

  };

  class GetWallResponse : public ros::Msg
  {
    public:
      typedef vector_map_msgs::WallArray _objects_type;
