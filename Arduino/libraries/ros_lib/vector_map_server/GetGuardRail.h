#ifndef _ROS_SERVICE_GetGuardRail_h
#define _ROS_SERVICE_GetGuardRail_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETGUARDRAIL[] = "vector_map_server/GetGuardRail";

  class GetGuardRailRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETGUARDRAIL; };
    const char * getMD5(){ return "d1f64bdec952e41012fc8c13f57fef77"; };

  };

  class GetGuardRailResponse : public ros::Msg
  {
    public:
      typedef vector_map_msgs::GuardRailArray _objects_type;
    ...
    const char * getType(){ return GETGUARDRAIL; };
    const char * getMD5(){ return "dfb68cd4dfb7fafca860fa32531caf66"; };
