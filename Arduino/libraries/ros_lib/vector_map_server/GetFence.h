#ifndef _ROS_SERVICE_GetFence_h
#define _ROS_SERVICE_GetFence_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETFENCE[] = "vector_map_server/GetFence";

  class GetFenceRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETFENCE; };
    const char * getMD5(){ return "d1f64bdec952e41012fc8c13f57fef77"; };

  };

  class GetFenceResponse : public ros::Msg
  {
    public:
      typedef vector_map_msgs::FenceArray _objects_type;
