#ifndef _ROS_SERVICE_GetZebraZone_h
#define _ROS_SERVICE_GetZebraZone_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETZEBRAZONE[] = "vector_map_server/GetZebraZone";

  class GetZebraZoneRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETZEBRAZONE; };
    const char * getMD5(){ return "d1f64bdec952e41012fc8c13f57fef77"; };

  };

  class GetZebraZoneResponse : public ros::Msg
  {
    public:
      typedef vector_map_msgs::ZebraZoneArray _objects_type;
      _objects_type objects;

    GetZebraZoneResponse():
      objects()
    {
    }
