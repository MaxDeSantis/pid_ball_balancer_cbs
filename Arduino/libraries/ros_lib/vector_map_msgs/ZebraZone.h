#ifndef _ROS_vector_map_msgs_ZebraZone_h
#define _ROS_vector_map_msgs_ZebraZone_h
...
namespace vector_map_msgs
{
  ...
  class ZebraZone : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vector_map_msgs/ZebraZone"; };
