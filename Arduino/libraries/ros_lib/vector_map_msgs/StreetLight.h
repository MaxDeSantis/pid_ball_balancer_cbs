#ifndef _ROS_vector_map_msgs_StreetLight_h
#define _ROS_vector_map_msgs_StreetLight_h
...
namespace vector_map_msgs
{
  ...
  class StreetLight : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vector_map_msgs/StreetLight"; };
    const char * getMD5(){ return "cf43a31db6b90cc4cf8070baeb164fe6"; };
