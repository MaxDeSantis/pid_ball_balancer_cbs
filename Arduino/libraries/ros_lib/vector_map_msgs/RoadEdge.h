#ifndef _ROS_vector_map_msgs_RoadEdge_h
#define _ROS_vector_map_msgs_RoadEdge_h
...
namespace vector_map_msgs
{
  ...
  class RoadEdge : public ros::Msg
  {
    ...
    const char * getType(){ return "vector_map_msgs/RoadEdge"; };
