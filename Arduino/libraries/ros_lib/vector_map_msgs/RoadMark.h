#ifndef _ROS_vector_map_msgs_RoadMark_h
#define _ROS_vector_map_msgs_RoadMark_h
...
namespace vector_map_msgs
{
  ...
  class RoadMark : public ros::Msg
  {
    ...
    const char * getType(){ return "vector_map_msgs/RoadMark"; };
    const char * getMD5(){ return "da20a5104558c92bc92163ecb67c4d2a"; };
