#ifndef _ROS_vector_map_msgs_RailCrossing_h
#define _ROS_vector_map_msgs_RailCrossing_h
...
namespace vector_map_msgs
{
  ...
  class RailCrossing : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vector_map_msgs/RailCrossing"; };
