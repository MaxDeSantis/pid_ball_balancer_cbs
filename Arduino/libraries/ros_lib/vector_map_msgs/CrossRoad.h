#ifndef _ROS_vector_map_msgs_CrossRoad_h
#define _ROS_vector_map_msgs_CrossRoad_h
...
namespace vector_map_msgs
{
  ...
  class CrossRoad : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vector_map_msgs/CrossRoad"; };
