#ifndef _ROS_vector_map_msgs_RoadSign_h
#define _ROS_vector_map_msgs_RoadSign_h
...
namespace vector_map_msgs
{
  ...
  class RoadSign : public ros::Msg
  {
    ...
    const char * getType(){ return "vector_map_msgs/RoadSign"; };
    const char * getMD5(){ return "f9f1b51375b01c19f9ea58dcf8a15876"; };
