#ifndef _ROS_vector_map_msgs_GuardRail_h
#define _ROS_vector_map_msgs_GuardRail_h
...
namespace vector_map_msgs
{
  ...
  class GuardRail : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vector_map_msgs/GuardRail"; };
    const char * getMD5(){ return "2d0ff5b1e0af44869f9a932047e313c4"; };
