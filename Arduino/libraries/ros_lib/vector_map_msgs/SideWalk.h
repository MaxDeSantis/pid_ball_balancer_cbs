#ifndef _ROS_vector_map_msgs_SideWalk_h
#define _ROS_vector_map_msgs_SideWalk_h
...
namespace vector_map_msgs
{
  ...
  class SideWalk : public ros::Msg
  {
    ...
    const char * getType(){ return "vector_map_msgs/SideWalk"; };
