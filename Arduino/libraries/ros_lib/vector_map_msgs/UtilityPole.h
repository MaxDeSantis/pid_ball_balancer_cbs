#ifndef _ROS_vector_map_msgs_UtilityPole_h
#define _ROS_vector_map_msgs_UtilityPole_h
...
namespace vector_map_msgs
{
  ...
  class UtilityPole : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vector_map_msgs/UtilityPole"; };
