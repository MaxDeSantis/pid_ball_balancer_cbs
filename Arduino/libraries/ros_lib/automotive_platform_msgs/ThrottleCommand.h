#ifndef _ROS_automotive_platform_msgs_ThrottleCommand_h
#define _ROS_automotive_platform_msgs_ThrottleCommand_h
...
namespace automotive_platform_msgs
{
  ...
  class ThrottleCommand : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "automotive_platform_msgs/ThrottleCommand"; };
