#ifndef _ROS_automotive_platform_msgs_BrakeFeedback_h
#define _ROS_automotive_platform_msgs_BrakeFeedback_h
...
namespace automotive_platform_msgs
{
  ...
  class BrakeFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "automotive_platform_msgs/BrakeFeedback"; };
