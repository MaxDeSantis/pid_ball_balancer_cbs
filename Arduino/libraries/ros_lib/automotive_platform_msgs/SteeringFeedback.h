#ifndef _ROS_automotive_platform_msgs_SteeringFeedback_h
#define _ROS_automotive_platform_msgs_SteeringFeedback_h
...
namespace automotive_platform_msgs
{
  ...
  class SteeringFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "automotive_platform_msgs/SteeringFeedback"; };
