#ifndef _ROS_autoware_can_msgs_CANPacket_h
#define _ROS_autoware_can_msgs_CANPacket_h
...
namespace autoware_can_msgs
{
  ...
  class CANPacket : public ros::Msg
  {
    public:
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->dat[i] >> (8 * 0)) & 0xFF;
      offset += sizeof(this->dat[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->len);
      for( uint32_t i = 0; i < 8; i++){
      this->dat[i] =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->dat[i]);
      }
    ...
    const char * getType(){ return "autoware_can_msgs/CANPacket"; };
    const char * getMD5(){ return "8315bda71683b8ece50e17e529eea4c1"; };
